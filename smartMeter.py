...
project_id="project-milestones-485816"
topic_name = "milestone2";   # change it for your topic name if needed
...
while(True):
    ...
    # create dictionary
    msg={"ID":ID, "time": int(time.time()), "profileName": profile_name, "temperature": temp,"humidity": humd, "pressure":pres};    
    ID=ID+1;
